...
var find = function find(el) {
  return (0, _jquery.default)("body").find(el);
};
...
var Clock = /*#__PURE__*/function () {
  function Clock() {
    ...
    this.time = (0, _moment.default)().format("hh:mm:ss");
    ...
    value: function update() {
      ...
      function updateTime() {
        if (proxy_Clock.direction === "forward") {
          proxy_Clock.time = (0, _moment.default)(proxy_Clock.time, "hh:mm:ss").add(1, "s").format("hh:mm:ss");
        } else {
          proxy_Clock.time = (0, _moment.default)(proxy_Clock.time, "hh:mm:ss").subtract(1, "s").format("hh:mm:ss");
        }
      }
  ...
  _createClass(Timepicker, [{
    ...
    value: function clickEvents() {
      find(".go").click(function () {
        proxy_Clock.time = (0, _moment.default)((0, _jquery.default)("input").val(), "HH:mm A").format("hh:mm:00");
        proxy_PlayPause.playbackState = "play";
      });
    }
  }]);
...
//# sourceMappingURL=/ProxifyPattern.e31bb0bc.js.map